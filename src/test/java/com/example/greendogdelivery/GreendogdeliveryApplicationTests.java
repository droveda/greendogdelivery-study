...
public class GreendogdeliveryApplicationTests {
	...
	@Test
	public void testFindItem2() throws Exception {
		String URL2 = "/api/itens/2";
		System.out.println(mvc.perform(get(URL2)).andDo(print()));
	...
	@Test
	public void testCadastraNovoPedido() throws Exception {
		String URL3 = "/rest/pedido/novo/1/1,2";
		System.out.println(mvc.perform(get(URL3)).andDo(print()));
